...
static NSString *const DPUINotificationControllerVersion = @"1.0.0.0";
...
-(instancetype)initPrivate
{
    ...
    if (self) {
        ...
        DNModuleDefinition *uiNotificationModule = [[DNModuleDefinition alloc] initWithName:NSStringFromClass([self class]) version:DPUINotificationControllerVersion];
        [[DNDonkyCore sharedInstance] registerModule:uiNotificationModule];
    }

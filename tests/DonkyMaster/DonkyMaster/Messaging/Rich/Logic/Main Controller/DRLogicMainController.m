...
static NSString * const DRLogicMainControllerVersion = @"1.0.0.1";
...
- (void)start {
    ...
    self.moduleDefinition = [[DNModuleDefinition alloc] initWithName:NSStringFromClass([self class]) version:DRLogicMainControllerVersion];

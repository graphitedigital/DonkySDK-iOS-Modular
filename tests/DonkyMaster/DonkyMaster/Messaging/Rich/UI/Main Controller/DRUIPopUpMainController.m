...
static NSString * const DRUIPopUpControllerVersion = @"1.0.0.0";
...
-(instancetype)initPrivate
{
    ...
    if (self) {
        ...
        DNModuleDefinition *richPopUpModule = [[DNModuleDefinition alloc] initWithName:NSStringFromClass([self class]) version:DRUIPopUpControllerVersion];
        [[DNDonkyCore sharedInstance] registerModule:richPopUpModule];
    }

...
@interface DRMessageViewController : UIViewController <UIPopoverControllerDelegate, UISplitViewControllerDelegate, UIWebViewDelegate>
...
/*!
 ...
 @param buttonItem the buttom item to be removed

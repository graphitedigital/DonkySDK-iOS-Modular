...
@property(nonatomic, strong) DPPushNotificationController *notificationController;
@end
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //Start modules before initialisation:
    //[[DPPushLogicSingleton sharedInstance] startPushLogic]; //Use this singleton OR

    self.notificationController = [[DPPushNotificationController alloc] init]; //Optional VS using singleton instance
